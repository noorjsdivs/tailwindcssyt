      ...
      <div className="max-w-7xl mx-auto px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-20">
        <div className="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
          <div className="flex">
            <div className="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <span className="flex items-center gap-x-1">
                Let is begins <ChevronRightIcon className="-mr-2 h-4 w-4" />
              </span>
            </div>
          </div>
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            impedit reiciendis deserunt, illum numquam obcaecati, veritatis sit
            ut facere est hic ex cumque explicabo veniam neque. Totam, neque
            reiciendis.
          </p>
          <div className="mt-10 flex items-center gap-x-6">
            ...
            <button className="text-sm font-semibold leading-6 text-gray-600">
              Learn more →
            </button>
          </div>
        </div>
        <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
          ...
          >
            ...
            >
              <Image src={mobilescreen} alt="mobilescreen" />
              {/* <img
